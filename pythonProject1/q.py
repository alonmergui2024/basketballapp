...
option = ["this week games", "all games"]
autocomplete_engine1 = Autocomplete(option)
...
def guest():
    #if fav:
     #   print("here are the games of your favorite team:", fav)
            ...
            if output[0].strip() == option[0]:
                ...
                table = [element for element in table if
                         "teams__col Table__TD" and "teams__col Table__TD" and "leaders__col Table__TD" and "broadcast__col Table__TD" and "tickets__col Table__TD" not in element.attrs.get(
                             "class", [])]
                ''''
                picture = results.find_all("img", class_="Image Logo Logo__lg")
                for i in picture:
                    print(i.img)
                ...
                for x, y, z in games:
                    ...
                    suggestions3 = autocomplete_engine2.suggest(team2[0])
